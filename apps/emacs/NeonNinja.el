...
(let ((colors '(;; Upstream theme color
                (dracula-bg      "#370000" "unspecified-bg" "unspecified-bg") ; official background
                (dracula-fg      "#F3FFFC" "#ffffff" "brightwhite") ; official foreground
                (dracula-current "#10C4BB" "#303030" "brightblack") ; official current-line/selection
                (dracula-region  "#454759" "#303030" "brightblack") ; dracula-current with fake 75% alpha
                (dracula-comment "#09000D" "#5f5faf" "blue")        ; official comment
                (dracula-cyan    "#00FFFF" "#87d7ff" "brightcyan")  ; official cyan
                (dracula-green   "#37CC00" "#5fff87" "green")       ; official green
                (dracula-orange  "#F7E300" "#ffaf5f" "brightred")   ; official orange
                (dracula-pink    "#FF00FF" "#ff87d7" "magenta")     ; official pink
                (dracula-purple  "#FF1073" "#af87ff" "brightmagenta") ; official purple
                (dracula-red     "#F70000" "#ff8787" "red")         ; official red
                (dracula-yellow  "#FFFF0D" "#ffff87" "yellow")      ; official yellow
                ;; Other colors
